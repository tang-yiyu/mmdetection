...
launcher = 'none'
load_from = 'work_dirs/adaptive_model_droneperson_selection9_faster-rcnn_r50_fpn_1x_coco/best_coco_bbox_mAP_50_epoch_12.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    metric='bbox',
    outfile_prefix=
    './work_dirs/adaptive_model_droneperson_selection9_faster-rcnn_r50_fpn_1x_coco/',
    type='DronePerson')
test_pipeline = [
    dict(backend_args=None, type='LoadTwoStreamImageFromFiles'),
    dict(keep_ratio=True, scale=(
...
work_dir = './work_dirs/adaptive_model_droneperson_selection9_faster-rcnn_r50_fpn_1x_coco/'
